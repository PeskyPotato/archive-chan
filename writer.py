...
def writeOP(thread, op):
    with open("threads/{}/{}.html".format(thread.board, thread.tid), "a+") as html_file:
        ...
        html_file.write('\t\t\t<span class="nameBlock">{}</span>\n'.format(op.name))
